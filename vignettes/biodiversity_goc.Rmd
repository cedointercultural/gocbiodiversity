...
Use loop to get data from GBIF, OBIS, iNaturalist
```{r gbif_data, echo=TRUE}
...
#No usamos ebird porque la APP no está diseñada para bajar grandes cantidades de datos

config_file <- here::here("config","query_config_final.json")

execute_bio_queries(config_file, polygon_file = NULL, output_dir = NULL)
